...
const Greeting = () => {
    ...
    return (
        <div className="">
            <div className='flex gap-3 items-center font-medium dark:text-[#CCCCCC] text-[32px]'>{currentDir.charAt(0).toUpperCase() + currentDir.slice(1)}<span className="flex items-center px-[14px] py-2 text-base font-bold dark:text-[#B3B3B3] text-[#4B4C4D] dark:bg-[#33373B] bg-[#F6F6F6] rounded">{todoAmount} todo</span></div>
